...
##QUEST 3
#Jak se mìní prùmìrná délka slov, když text roste?
...
#QUEST: BOOTSTRAP (asi špatnì, malý rozptyld  )
...
#1. využívá italština odlišnou délku slov než nìmèina, angliètina.
#2. Jeden výzkumník tvrdí, že velikost slovníku dokáže bez problému odlišit dva autory.
#Ukažte na libovolné dvojici autorù reprezentované 1 knihou (seøiznutou na stejnou délku), zda to platí.
#3. Je v èeštinì "y" používáno více než "i"? TokenizeText(plainText, "[yi]", regexlsMask=TRUE)
